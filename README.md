...
| `horizontalGesture`     | `boolean` | `false`                | If you want to use horizontal input to scroll in your page                                                                                                                                                                                                                                         |
