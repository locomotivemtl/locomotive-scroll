...
| `touchMultiplier`   | `number`  | `4`                    | Mutiply the touch action by this modifier to make scroll faster than finger movement. |
...
<script
    nomodule
    src="https://polyfill.io/v3/polyfill.min.js?features=Object.assign%2CElement.prototype.append%2CNodeList.prototype.forEach%2CCustomEvent"
    crossorigin="anonymous"
></script>
```
